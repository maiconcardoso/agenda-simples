...
<head>
<meta charset="UTF-8">
<title>Agenda de Contato - Editar</title>
...
<body>
	...
	<form name="frmContato" action="update">
		<table>
			<tr>
				<td>
					<input type="text" name="idcon" id="caixa2" readonly value="<%out.print(request.getAttribute("idcon")); %>">
				</td>
			</tr>
			<tr>
		...
		<input class="btn" type="button" value="Salvar" onclick="validar()">
	</form>
